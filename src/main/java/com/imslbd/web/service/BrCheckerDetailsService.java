package com.imslbd.web.service;
...
public class BrCheckerDetailsService {
    public static final int apiPort = WebApp.loadConfig().getJsonObject(io.crm.web.service.callreview.BrCheckerDetailsService.class.getSimpleName(), new JsonObject()).getInteger("apiPort");
    public static final String apiHost = WebApp.loadConfig().getJsonObject(io.crm.web.service.callreview.BrCheckerDetailsService.class.getSimpleName()).getString("apiHost");
