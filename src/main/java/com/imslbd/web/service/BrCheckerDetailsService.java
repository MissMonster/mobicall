...
public class BrCheckerDetailsService {
    public static final int apiPort = App.loadConfig().getJsonObject(io.crm.web.service.callreview.BrCheckerDetailsService.class.getSimpleName(), new JsonObject()).getInteger("apiPort");
    public static final String apiHost = App.loadConfig().getJsonObject(io.crm.web.service.callreview.BrCheckerDetailsService.class.getSimpleName()).getString("apiHost");
